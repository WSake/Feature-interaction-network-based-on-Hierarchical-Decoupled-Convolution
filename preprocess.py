...
train_set = {
        'root': '/data2/zhangyj/data/BraTS2018/MICCAI_BraTS_2018_Data_Training/',
        'flist': 'all.txt',
        }

valid_set = {
        'root': '/data2/zhangyj/data/BraTS2018/MICCAI_BraTS_2018_Data_Validation/',
        'flist': 'valid.txt',
        }

test_set = {
        'root': '/data2/BraTS/MICCAI_BraTS_2018_Data_Validation/',
        'flist': 'test.txt',
        }
